                ...
                <tbody>
                    ...
                    @foreach($users as $user)
                        <tr>
                            ...
                            <td>{{ $user->persona->phone }}</td>
                            <td>{{ $user->persona->address }}</td>
                            <td><span class="label label-info">{{ $user->persona->face }}</span></td>
                            <td class="text-center">
                                <div class="btn-group">
                                    <a href="{{ route('usuarios.edit', $user) }}" data-toggle="tooltip" title="Editar" class="btn btn-xs btn-default"><i class="fa fa-pencil"></i></a>
                                    <form method="POST"
