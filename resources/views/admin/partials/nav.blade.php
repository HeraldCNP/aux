<ul class="sidebar-nav">
    ...
    <li>
        <a href="#" class="sidebar-nav-menu {{ request()->is('videos*') ? 'active' : '' }}"><i class="fa fa-angle-left sidebar-nav-indicator sidebar-nav-mini-hide"></i><i class="fa fa-users sidebar-nav-icon"></i><span class="sidebar-nav-mini-hide">Videos</span></a>
        <ul>
            <li>
                <a href="{{ route('videos.index') }}" class="{{ request()->is('videos') ? 'active' : '' }}">Ver Todos <i class="fa fa-eye sidebar-nav-indicator sidebar-nav-mini-hide"></i></a>
            </li>
            <li>
                <a href="{{ route('videos.create') }}">Agregar Nuevo <i class="fa fa-user-plus sidebar-nav-indicator sidebar-nav-mini-hide"></i></a>
            </li>
        </ul>
    </li>
